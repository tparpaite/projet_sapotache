...
unsigned int gameCleint_get_id(game_t this){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    return extra_data->id;
}
enum p_type gameCleint_get_type(game_t this){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    return extra_data->type;
}
size_t gameCleint_get_n_player_cards(game_t this){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    return extra_data->n_player_cards;
}
enum card_id gameCleint_get_ith_player_cards(game_t this, size_t i){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    return extra_data->player_cards[i];
}

int gameCleint_set_id(game_t this, unsigned int new_id){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    extra_data->id = new_id;
    return 0;
}
int gameCleint_set_type(game_t this, enum p_type new_type){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    extra_data->type = new_type;
    return 0;
}
int gameCleint_set_n_player_cards(game_t this, size_t new_n){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
    extra_data->n_player_cards = new_n;
    return 0;
}
int gameCleint_set_ith_player_cards(game_t this, size_t i, enum card_id new_card){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
...
int gameCleint_remove_card(game_t this, size_t i_card){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
...
int gameCleint_add_card(game_t this, enum card_id new_card){
    struct client_extra_data_s *extra_data = game_get_extra_data(this);
